    ...
    where TEvent : notnull
{
    ...
    private ExecutionPolicy initialStateExecutionPolicy;
    ...
    public StateMachineBuilder<TState, TEvent, TRecipient> SetInitialState(TState state, ExecutionPolicy initializationPolicy = ExecutionPolicy.ParentFirst)
    {
    ...
    /// <exception cref="InvalidOperationException">Thrown when <see cref="StateMachineBuilder{TState, TEvent, TRecipient}.Finalize"/> or <see cref="StateBuilder{TState, TEvent, TRecipient}.Finalize"/> has already been called in this builder's hierarchy.<br/>
    /// Thrown when <see cref="SetInitialState(TState, ExecutionPolicy)"/> was not called.<br/>
