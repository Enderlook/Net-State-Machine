...
{
    /// <summary>
    /// Parameters builder of method <see cref="FireImmediatelyWithParameters(TEvent)"/>.
    /// </summary>
    public readonly struct FireImmediatelyParametersBuilder
    {
        ...
        internal FireImmediatelyParametersBuilder(StateMachine<TState, TEvent, TRecipient> stateMachine, TEvent @event)
        {
